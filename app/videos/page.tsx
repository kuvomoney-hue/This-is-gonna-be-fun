    ...
    <div className="p-6 space-y-6">
      ...
      {error && (
        <div className="bg-[#1e1010] border border-[#4a1010] rounded-lg p-4 text-[#ef9a9a] text-sm">
          ⚠️ {error} — YouTube RSS may be blocked server-side. Try again later.
        </div>
      )}
      ...
      {!loading && videos.length === 0 && !error && (
        <Card title="No videos found">
          <p className="text-[#81c784] text-sm">
            Could not fetch videos from RSS feeds. YouTube may be blocking
            server-side requests. Check back later.
          </p>
        </Card>
      )}
    </div>
